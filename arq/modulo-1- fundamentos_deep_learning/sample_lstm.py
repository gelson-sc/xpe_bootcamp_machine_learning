...
time_steps = 10  # Janela de tempo para entrada na LSTM
...
X = X.reshape((X.shape[0], X.shape[1], 1))  # Adicionando dimensão extra para entrada da LSTM

# Criando o modelo LSTM
model = tf.keras.Sequential([
    tf.keras.layers.LSTM(50, activation='relu', return_sequences=True, input_shape=(time_steps, 1)),
